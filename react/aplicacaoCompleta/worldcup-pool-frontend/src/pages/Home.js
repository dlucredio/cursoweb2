...
function Home() {
    return (
        <div className="bg-white w-full h-screen flex flex-col justify-center items-center">
            <div className="bg-gray-300 flex flex-col justify-center items-center w-full h-full md:w-fit md:h-fit md:p-16 md:rounded-3xl">
            <div className="text-blue-800 text-center pb-12 text-2xl font-black uppercase">Bolão da copa</div>
