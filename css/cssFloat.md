...
1. Criar um arquivo chamado `indexFloat.html`, com o seguinte conteúdo:
...
2. Agora vamos aplicar cores e estilos. Criar o arquivo `style.css`, com o seguinte conteúdo inicial:
...
3. Modificar o arquivo `indexFloat.html` para adicionar os estilos:
...
4. Agora vamos adicionar o layout responsivo. Adicionar o arquivo `styleFloat.css` para adicionar as seguintes classes:
...
5. Modificar o arquivo `indexFloat.html` para referenciar esse novo arquivo e definir as posições e a responsividade dependendo do tamanho da tela:
...
7. Modificar o arquivo `indexFloat.html` para adicionar os tamanhos intermediários aos elementos:
